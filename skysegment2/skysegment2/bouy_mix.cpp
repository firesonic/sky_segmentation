...
//    const int cannyThresholdInitialValue = 177;
//    const int accumulatorThresholdInitialValue = 6;
...
//
//    // Read the image
//    src = imread( "C:/bouy/test_en_rgb.png", 1 );
//
//    if( src.empty() )
//    {
...
//			int temp = (((int)src.at<Vec3b>(i,j)[1]) + ((int)src.at<Vec3b>(i,j)[2]))/2;
