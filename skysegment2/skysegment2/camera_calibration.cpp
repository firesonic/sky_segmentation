...
//        //! [await_input]
//		Mat view_show = view.clone();
//		resize(view_show,view_show,Size(640,480));
//        imshow("Image View", view_show);
...
//			Mat rview_show = rview.clone();
//			resize(rview_show,rview_show,Size(640,480));
//            imshow("Image View", rview_show);
//            char c = (char)waitKey();
